...
export const CtaBanner = () => {
    ...
    return (
        <div className='container mx-auto px-4 mt-10 lg:mt-48'>
            <div className='bg-[url(/images/cta-background.png)] bg-cover bg-center bg-no-repeat rounded-3xl lg:rounded-4xl py-7 lg:py-6 px-9 lg:px-14 flex flex-col lg:flex-row items-center justify-between'>
