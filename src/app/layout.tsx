  ...
  return (
    <html lang={locale} dir="rtl">
      <head>
        ...
        <link rel="apple-touch-startup-image" href="/icons/splash-640x1136.svg" media="(device-width: 375px) and (device-height: 667px) and (-webkit-device-pixel-ratio: 2)" />
        <link rel="apple-touch-startup-image" href="/icons/splash-640x1136.svg" media="(device-width: 414px) and (device-height: 736px) and (-webkit-device-pixel-ratio: 3)" />
      </head>
