...
import { ConsignmentCard } from "../cards/consignment";
...
export interface ConsignmentsCarouselProps {
    title: string
}

export const ConsignmentsCarousel = ({ title }: ConsignmentsCarouselProps) => {
